...
define('text!resources/langs/fr.json',[],function () { return '{\n    "language": "Français",\n    "input": "Qu\'est-ce qui doit être fait?",\n    "controls": {\n        "clear": "Supprimer terminée",\n        "all": "Toutes",\n        "active": "Active",\n        "completed": "Terminés"\n    }\n}';});
...
define('text!resources/templates/todo.html',[],function () { return '<div class="todo-inner <% if (model.get("done")) { %>done<% } %>">\n    <input type="checkbox" <% if (model.get("done")) { %>checked<% } %> />\n    <a href="#" class="do-remove-todo">&times;</a>\n    <input type="text" class="title-input" value="<%- model.get("title") %>" />\n</div>';});
...
define('text!resources/templates/main.html',[],function () { return '<select class="do-select-languages">\n<% _.each(langs, function(lang, langId) { %>\n    <option value="<%- langId %>" <% if (currentLang == langId) { %>selected<% } %>><%- lang.language %></option>\n<% }); %>\n</select>\n\n<div class="container">\n    <div class="input">\n        <input type="text" placeholder="<%- hr.i18n.t("input") %>" />\n    </div>\n    <div class="list">\n\n    </div>\n    <div class="controls">\n        <a href="#" class="do-clear-completed"><%- hr.i18n.t("controls.clear") %> (<span class="count-completed"><%- countCompleted %></span>)</a>\n        <a href="#filter/all"><%- hr.i18n.t("controls.all") %></a> <a href="#filter/active"><%- hr.i18n.t("controls.active") %></a> <a href="#filter/completed"><%- hr.i18n.t("controls.completed") %></a>\n    </div>\n</div>';});
